  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-gold text-primary-foreground hover:opacity-90 shadow-lg hover:shadow-xl",
        "gold-outline": "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground",
        elegant: "bg-transparent border border-primary/50 text-foreground hover:border-primary hover:text-primary tracking-widest uppercase",
      },
      size: {
